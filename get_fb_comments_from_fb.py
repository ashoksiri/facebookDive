...
def processFacebookComment(comment, status_id, parent_id=''):
    ...
    comment_author_id = unicode_decode(comment['from']['id'])
    ...
    return (comment_id, status_id, parent_id, comment_message, comment_author,comment_author_id,
