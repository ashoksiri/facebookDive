...
#conf = SparkConf().setMaster("local[2]").setAppName("Hai")
...
def scrapeFacebookPageFeedStatus(page_id, access_token):
    with open('{}_facebook_statuses.json'.format(page_id), 'w') as file:
        #w = csv.writer(file)
        ...
        while has_next_page:
            ...
            for status in statuses['data']:
                ...
                if 'reactions' in status:
                    ...
                    reaction_types = ['like', 'love', 'wow', 'haha', 'sad', 'angry']
                    reactions_data = reactions[status_data['status_id']]
                    for i in range(0,6):
                        status_data[reaction_types[i]] = reactions_data[i]

                    postjsonList.append(json.dumps(status_data))
